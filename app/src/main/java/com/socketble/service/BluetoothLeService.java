...
public class BluetoothLeService extends Service {
    ...
    public final static String RSSI_VALUE = "com.honeywell.hch.airtouch.plateform.ble.RSSI_VALUE";
    ...
    private BluetoothGattCallback mBluetoothGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                if (status == 0) {
                    ...
                    LogUtil.log(LogUtil.LogLevel.INFO, TAG, "Connected to GATT server." + gatt.getDevice().getAddress());
                ...
                LogUtil.log(LogUtil.LogLevel.INFO, TAG, "Disconnected from GATT server." + gatt.getDevice().getAddress());
                broadcastUpdate(intentAction, gatt.getDevice().getAddress(), gatt.getDevice().getName());
                gatt.close();
            }
        }
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                LogUtil.log(LogUtil.LogLevel.INFO, TAG, "onServicesDiscovered");
                broadcastUpdate(ACTION_GATT_SERVICES_DISCOVERED, gatt.getDevice().getAddress(), gatt.getDevice().getName());
            } else {
                LogUtil.log(LogUtil.LogLevel.INFO, TAG, "onServicesDiscovered received: " + status);
            }
        }
        ...
        public void onCharacteristicRead(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                LogUtil.log(LogUtil.LogLevel.INFO, TAG, "onCharacteristicRead "
        ...
        public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            LogUtil.log(LogUtil.LogLevel.INFO, TAG, "onCharacteristicWrite "
                    + characteristic.getUuid()
                    + " value " + Arrays.toString(characteristic.getValue()));

            Log.i(TAG, "success onCharacteristicWrite "
                    + characteristic.getUuid()
                    + " value " + Arrays.toString(characteristic.getValue()));
        ...
        public void onDescriptorWrite(BluetoothGatt gatt, BluetoothGattDescriptor descriptor, int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                LogUtil.log(LogUtil.LogLevel.INFO, TAG, "onDescriptorWrite");
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
            LogUtil.log(LogUtil.LogLevel.INFO, TAG, "onCharacteristicChanged:" + Arrays.toString(characteristic.getValue()));
...
//        close();
    ...
    public boolean initialize() {
        ...
        if (mBluetoothManager == null) {
            ...
            if (mBluetoothManager == null) {
                LogUtil.log(LogUtil.LogLevel.INFO, TAG, "Unable to initialize BluetoothManager.");
                return false;
            }
        }
        ...
        if (mBluetoothAdapter == null) {
            LogUtil.log(LogUtil.LogLevel.INFO, TAG, "Unable to obtain a BluetoothAdapter.");
            return false;
        }
            ...
            if (BluetoothDevice.ACTION_BOND_STATE_CHANGED.equals(action)) {
                ...
                switch (device.getBondState()) {
                    case BluetoothDevice.BOND_BONDING:
                        LogUtil.log(LogUtil.LogLevel.INFO, TAG, "BOND_BONDING");
                        break;
                    case BluetoothDevice.BOND_BONDED:
                        LogUtil.log(LogUtil.LogLevel.INFO, TAG, "BOND_BONDED");
...
//                        }
                    ...
                    case BluetoothDevice.BOND_NONE:
                        LogUtil.log(LogUtil.LogLevel.INFO, TAG, "BOND_NONE");
            ...
            if (action.equals(BluetoothAdapter.ACTION_STATE_CHANGED)) {
                ...
                switch (state) {
                    case BluetoothAdapter.STATE_OFF:
                        LogUtil.log(LogUtil.LogLevel.INFO, TAG, "Phone bluetooth off.");
                        broadcastUpdate(ACTION_PHONE_BLUETOOTH_OFF, "", "");
                        break;
                    case BluetoothAdapter.STATE_ON:
                        LogUtil.log(LogUtil.LogLevel.INFO, TAG, "Phone bluetooth on.");
    ...
    public boolean connect(final String address) {
        if (mBluetoothAdapter == null || address == null) {
            LogUtil.log(LogUtil.LogLevel.INFO, TAG, "BluetoothAdapter not initialized or unspecified address.");
            return false;
        }
        ...
        if (device == null) {
            LogUtil.log(LogUtil.LogLevel.INFO, TAG, "Device not found.  Unable to connect.");
            return false;
        }
...
//        mBluetoothGattHashMap.put(address, gatt);
        LogUtil.log(LogUtil.LogLevel.INFO, TAG, "Trying to create a new connection.");
...
//        }
    ...
    private final BroadcastReceiver mClearSameTypeDeviceReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (ACTION_CLEAR_SAME_TYPE_DEVICE.equals(action)) {
                ...
                mBluetoothGattHashMap.clear();
                LogUtil.log(LogUtil.LogLevel.INFO, TAG, "mBluetoothGattHashMap.put:");
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
        ...
        LogUtil.log(LogUtil.LogLevel.INFO, TAG, "setCharacteristicNotification");
